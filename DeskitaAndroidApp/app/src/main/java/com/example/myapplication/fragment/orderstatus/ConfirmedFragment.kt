...
class ConfirmedFragment(var lstConfirmedOrders: ArrayList<Order>,var activity: MyOrdersActivity) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lstvConfOrders.adapter = OrderAdapter(activity,lstConfirmedOrders)
    }
}